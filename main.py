...
if page == "🎯 Калькулятор & Подбор Вуза":
    ...
    if not results:
        st.warning("⚠️ По выбранным критериям не найдено направлений. Попробуйте сбросить фильтры или изменить город!")
